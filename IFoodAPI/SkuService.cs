...
namespace IFoodAPI
{
    public static class SkuService
    {
        public static async Task<List<OptionGroup>> GetComplements(Sku sku)
        {
            ...
            using (HttpRequestMessage request = new HttpRequestMessage(HttpMethod.Get, $"v1.0/merchants/{IFoodAPIService.Config.MerchantId}/skus/{sku.Id}/option_groups"))
            {
        ...
        public static async Task Create(Sku sku)
        {
            ...
            using (HttpRequestMessage request = new HttpRequestMessage(HttpMethod.Post, "v1.0/skus"))
            {
                request.Headers.Add("Authorization", AuthService.Token.FullToken);
        ...
        public static async Task Update(Sku sku)
        {
            ...
            using (HttpRequestMessage request = new HttpRequestMessage(new HttpMethod("PATCH"), $"v1.0/skus/{sku.ExternalCode}"))
            {
                request.Headers.Add("Authorization", AuthService.Token.FullToken);
        ...
        public static async Task UpdatePrice(Sku sku)
        {
            ...
            using (HttpRequestMessage request = new HttpRequestMessage(new HttpMethod("PATCH"), $"v1.0/skus/{sku.ExternalCode}/prices"))
            {
                request.Headers.Add("Authorization", AuthService.Token.FullToken);
        ...
        public static async Task LinkOptionGroup(Sku sku, OptionGroup optionGroup)
        {
            ...
            using (HttpRequestMessage request = new HttpRequestMessage(HttpMethod.Post, $"v1.0/skus/{sku.ExternalCode}/option-groups:link"))
            {
                request.Headers.Add("Authorization", AuthService.Token.FullToken);
        ...
        private static async Task ChangeStatus(Sku sku, string status)
        {
            ...
            using (HttpRequestMessage request = new HttpRequestMessage(new HttpMethod("PATCH"), $"v1.0/merchants/{IFoodAPIService.Config.MerchantId}/skus/{sku.ExternalCode}"))
            {
                request.Headers.Add("Authorization", AuthService.Token.FullToken);
